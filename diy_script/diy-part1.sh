...
# CONFIG_PACKAGE_kmod-hinic3 is not set
...
CONFIG_PACKAGE_kmod-libie-adminq=y
CONFIG_PACKAGE_kmod-libie-fwlog=y
...
# CONFIG_PACKAGE_luci-i18n-dockerman-ga is not set
...
# CONFIG_PACKAGE_luci-i18n-dockerman-ta is not set
...
# CONFIG_PACKAGE_luci-i18n-openlist-fa is not set
...
# CONFIG_PACKAGE_luci-i18n-openlist-ta is not set
